...
HOME_TEXT = "👋🏻 **Hi [{}](tg://user?id={})**,\n\nI'm **Radio Player V5.0** \nI Can Play Radio / Music / YouTube Live In Channel & Group 24x7 Nonstop. Made with ❤️ By @Shnider_Bots 😉!"
HELP_TEXT = """
🎧 --**Need Help ?**--
(Join @Shnider_Bots For Support)
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "replay":
        ...
        buttons = [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/Shnider_Bots"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/Shnider_Bots"),
            ],
...
async def help(client, message):
    ...
    msg['help'] = await message.reply_photo(photo="https://telegra.ph/file/0492f9f147304ce87a020.png", caption=HELP_TEXT, reply_markup=reply_markup)
    await mp.delete(message)
