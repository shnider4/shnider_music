...
async def not_chat(_, m: Message):
    buttons = [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/shnider_Bot"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/shnider_Bot"),
            ],

         ]
    k=await m.reply_photo(photo="https://telegra.ph/file/0492f9f147304ce87a020.png", caption="**Sorry, You Can't Use This Bot In This Group! 🤷‍♂ ")
    await mp.delete(m)
